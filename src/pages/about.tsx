    ...
    <>
      ...
      <div className="max-w-3xl">
        ...
        <div className="prose prose-gray">
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Data Sources</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={source.name} className="bg-white rounded border border-gray-200 p-3">
                <a href={source.url} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-orange-600 hover:underline">{source.name}</a>
                <p className="text-sm text-gray-600 mt-0.5">{source.desc}</p>
              </div>
            ))}
          </div>

          <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Technology</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Contributing</h2>
          <p className="text-gray-600 text-sm">
            This project is maintained by{" "}
            <a href="https://github.com/indiaemerges" target="_blank" rel="noopener noreferrer" className="text-orange-600 hover:underline">
              indiaemerges
            </a>
